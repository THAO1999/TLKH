...
// get data of Sensers from file data
	...
	public static void calculateRemainingEnergyOfSensorNode(ArrayList<Sensor> sensors) {
		...
		Float enrgyConsumption, remainingEnergy; // khởi tao năng lương tiêu thụ , năng lương còn lại
		for (; i < length; i++) {
			if (sensors.get(i).getSentRequest() == 0) // kiểm tra xem sensor đã gửi yêu cầu hay chưa, nếu chưa gửi yc thì tính năng lượng
			{
				enrgyConsumption = sensors.get(i).getP() * 1000; // năng lượng tiêu thụ trong 1000s
				remainingEnergy = sensors.get(i).getEnergy() - enrgyConsumption; // năng lương còn lại
